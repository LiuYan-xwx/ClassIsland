...
<img src="/static/主界面.png" style="zoom:50%;" />

### 提醒

可使用全屏强调特效、置顶窗口、语音或音效来增强提醒
...
- 课表
  - <img src="/static/课表.png" alt="课表" style="zoom:50%;" />
- 时间表
  - 时间线视图
    - <img src="/static/时间表（时间线）.png" alt="时间表（时间线）" style="zoom:50%;" />
  - 列表视图
    - <img src="/static/时间表（列表）.png" alt="时间表（列表）" style="zoom:50%;" />
